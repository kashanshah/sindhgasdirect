	...
	if(isset($_REQUEST['ids']) && is_array($_REQUEST['ids']))
	{
		foreach($_REQUEST['ids'] as $CID)	
		{
			...
			$_SESSION["msg"] = '<div class="alert alert-danger alert-dismissable">
                    ...
                    <h4><i class="icon fa fa-ban"></i> Category(ies) Deleted!</h4>
                  </div>';
		}
	}
	if(isset($_REQUEST['DID']))
	{
			$query = "DELETE FROM categories WHERE ID = ".$_REQUEST['DID']."";
			mysql_query($query);
			$_SESSION["msg"] = '<div class="alert alert-danger alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <h4><i class="icon fa fa-ban"></i> Category Deleted!</h4>
                  </div>';
			redirect($self);
	}

$sql="SELECT ID, Name, Description, DATE_FORMAT(DateAdded, '%D %M\'%y') AS DateAdded, DATE_FORMAT(DateModified, '%D %M\'%y') AS DateModified FROM categories";
              ...
              <div class="box">
                <div class="box-header">
                      <div class="btn-group-right">
                       ...
                       <button style="float:right;;margin-right:15px;" type="button" class="btn btn-group-vertical btn-success" onClick="location.href='addcategory.php'" data-original-title="" title="">Add New</button>
                        ...
                        <td>
							<div class="btn-group">
							  ...
							  <ul class="dropdown-menu" role="menu">
								<li><a href="editcategory.php?ID=<?php echo $row["ID"]; ?>">Edit</a></li>
								<li class="divider"></li>
