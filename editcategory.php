...
if(isset($_POST['editstd']) && $_POST['editstd']=='Update')
{
	...
	if($msg=="")
	{
		...
		$_SESSION["msg"]='<div class="alert alert-success alert-dismissable">
					...
					Category description has been updated.
				</div>';
...
<html>
  <head>
    ...
    <title><?php echo SITE_TITLE; ?>- Edit Category</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="categories.php"><i class="fa fa-folder-open"></i> categories</a></li>
              ...
              <div class="box ">
                <div class="box-header">
                      <div class="btn-group-right">
                       <button style="float:right;" type="button" class="btn btn-group-vertical btn-danger" onClick="location.href='categories.php'" >Back</button>
...
<?php if(isset($_SESSION["msg"]) && $_SESSION["msg"] != "")  { echo $_SESSION["msg"]; $_SESSION["msg"]=""; } ?>
              <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
						<label class="col-md-3 control-label" for="eventple-text-input">Description</label>
						<div class="col-md-6">
