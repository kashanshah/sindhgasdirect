...
if(isset($_REQUEST['ids']) && is_array($_REQUEST['ids']))
{
    ...
    {
        //echo $CID;exit();
        $query = "DELETE FROM vehicles WHERE ID = ".$CID."";
        mysql_query($query);
        $_SESSION["msg"] = '<div class="alert alert-danger alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <i class="icon fa fa-ban"></i> Vehicle(s) Deleted!
                  </div>';
    }
}
if(isset($_REQUEST['DID']))
{
    $query = "DELETE FROM vehicles WHERE ID = ".$_REQUEST['DID']."";
    mysql_query($query);
    $_SESSION["msg"] = '<div class="alert alert-danger alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <i class="icon fa fa-ban"></i> Vehicle Deleted!
                  </div>';
    redirect($self);
}

$sql="SELECT * FROM vehicles WHERE ID<>0 ".(($_SESSION["RoleID"] == ROLE_ID_ADMIN) ? '' : " AND PlantID='".$_SESSION["ID"]."'")." order by ID DESC";
...
<head>
    ...
    <title><?php echo SITE_TITLE; ?>- Vehicles</title>
                        ...
                        <?php if($_SESSION["RoleID"] == ROLE_ID_ADMIN || $_SESSION["RoleID"] == ROLE_ID_PLANT){?>
                            <div class="box-header">
                                <div class="btn-group-right">
                                    ...
                                    <a style="float:right;margin-right:15px;" type="button" class="btn btn-group-vertical btn-success" href="addvehicle.php" data-original-title="" title="">Add Vehicle</a>
