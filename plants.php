...
if(isset($_REQUEST['ids']) && is_array($_REQUEST['ids']))
{
    foreach($_REQUEST['ids'] as $CID)
    {
        ...
        $_SESSION["msg"] = '<div class="alert alert-danger alert-dismissable">
                    ...
                    <i class="icon fa fa-ban"></i> Plant(s) Deleted!
                  </div>';
    }
}
if(isset($_REQUEST['DID']))
{
    ...
    $_SESSION["msg"] = '<div class="alert alert-danger alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <i class="icon fa fa-ban"></i> Plant Deleted!
                  </div>';
    redirect($self);
}

$sql="SELECT u.ID, u.Username, u.Password, u.Balance, u.Remarks, u.ShopID, r.Name AS Role, u.Address, u.Number, u.Name FROM users u LEFT JOIN roles r ON r.ID = u.RoleID where u.ID<>0 AND u.RoleID = ".(int)ROLE_ID_PLANTS;
...
<head>
    ...
    <title><?php echo SITE_TITLE; ?>- Plants Management</title>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <div class="btn-group-right">
                                ...
                                <a style="float:right;margin-right:15px;" type="button" class="btn btn-group-vertical btn-success" href="addplant.php" data-original-title="" title="">Add New</a>
