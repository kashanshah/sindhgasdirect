...
if (isset($_POST['addstd']) && $_POST['addstd'] == 'Save') {
    ...
    if ($msg == "") {
        ...
        sendSMS(ALERT_RECEIVER, 'Cylinder - New Cylinder with Barcode ' . $BarCode . ', Manufacturing Date ' . $ManufacturingDate . ', Expiry Date ' . $ExpiryDate . ' having T.W ' . $TierWeight . '  has been added at ' . date('h:iA d-m-Y'));
        $message = 'Cylinder - New Cylinder with Barcode ' . $BarCode . ', Manufacturing Date ' . $ManufacturingDate . ', Expiry Date ' . $ExpiryDate . ' having T.W ' . $TierWeight . '  has been added at ' . date('h:iA d-m-Y');
                        ...
                        <div class="box box-default">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input readonly="" type="text" class="form-control" id="example-text-input"
                                               value="<?php $i = mysql_fetch_array(mysql_query("SELECT MAX(ID) AS MA FROM cylinders"));
                                               echo $i["MA"] + 1; ?>" placeholder="" name="CylinderID">
                                        <p>Auto-generated by the system</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="example-text-input">Manufacturing Date
                                        *</label>
                                    <div class="col-md-6">
                                        <input type="date" class="form-control" id="example-text-input"
                                               value="<?php echo $ManufacturingDate; ?>" name="ManufacturingDate"
                                               required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" id="example-text-input"
                                               value="<?php $i = mysql_fetch_array(mysql_query("SELECT MAX(ID) AS MA FROM cylinders"));
                                               echo $i["MA"] + 1; ?>" placeholder="" name="BarCode">
                                        <p><span>*</span>Bar Code must be unique</p>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="example-text-input">Tier Weight(KG)
                                        *</label>
                                    <div class="col-md-6">
                                        <input type="number" class="form-control" id="example-text-input"
                                               value="<?php echo $TierWeight; ?>"
                                               placeholder="Enter Tier Weight in KG's" step="any" name="TierWeight"
                                               required>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="ShortDescription">Short
                                        Description</label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" id="ShortDescription"
                                                  placeholder="Enter Short Description"
                                                  name="ShortDescription"><?php echo $ShortDescription; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
