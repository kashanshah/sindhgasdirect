		...
		<div class="row">
			  ...
			  <div class="info-box">
				...
				<div class="info-box-content">
				  ...
				  <!-- MONTHLY -->
				  <span class="info-box-number"><?php echo @mysql_result(mysql_query("SELECT COUNT(ID) AS Count FROM products WHERE ".($_SESSION["RoleID"] != 1 ? " AddedBy = '".dbinput($_SESSION["ID"])."' AND " : '')." DATE_FORMAT(DateAdded, '%Y-%m-%d') >= '".date('Y-m-01')."' "), 0); ?></span>
				</div>
				<!-- /.info-box-content -->
			  </div>
			  <!-- /.info-box -->
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
			  <div class="info-box">
				...
				<div class="info-box-content">
				  ...
				  <!-- DAILY 0 -->
				  <span class="info-box-number"><?php echo @mysql_result(mysql_query("SELECT COUNT(ID) AS Count FROM products WHERE ".($_SESSION["RoleID"] != 1 ? " AddedBy = '".dbinput($_SESSION["ID"])."' AND " : '')." DATE_FORMAT(DateAdded, '%Y-%m-%d') >= '".date('Y-m-d')."'"), 0); ?></span>
				</div>
				<!-- /.info-box-content -->
			  </div>
			  <!-- /.info-box -->
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
			  <div class="info-box">
				...
				<div class="info-box-content">
				  <span class="info-box-text">Inventory Out</span>
				  <span class="info-box-number"><?php echo @mysql_result(mysql_query("SELECT COUNT(ID) AS Count FROM orders WHERE ".($_SESSION["RoleID"] != 1 ? " AddedBy = '".dbinput($_SESSION["ID"])."' AND " : '')." Bookmarked = 1"), 0); ?></span>
				</div>
				<!-- /.info-box-content -->
			  </div>
			  <!-- /.info-box -->
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
			  <div class="info-box">
				...
				<div class="info-box-content">
				  ...
				  <!-- Monthly New Consignees -->
				  <span class="info-box-number"><?php echo @mysql_result(mysql_query("SELECT COUNT(ID) AS Count FROM products WHERE DATE_FORMAT(DateAdded, '%Y-%m-%d') >= '".date('Y-m-01')."' AND Status = 1"), 0); ?></span>
				</div>
				<!-- /.info-box-content -->
			  </div>
			  <!-- /.info-box -->
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <p class="text-center">
                    <strong>Sales: <?php echo date('M, Y', strtotime("-11 months")); ?> - <?php echo date("M, Y"); ?></strong>
                  </p>
...
<!--                    <span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 17%</span>-->
                    <h5 class="description-header">Rs. <span id="Revenue">0</span></h5>
                ...
                <div class="col-md-6 text-center">
                  <div class="description-block border-right">
<!--                    <span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 17%</span>-->
                    <h5 class="description-header">Rs. <span id="MonthRevenue">0</span></h5>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <ul class="chart-legend clearfix">
						<li><i class="fa fa-circle-o text-red"></i>&nbsp;&nbsp;&nbsp; <strong class="pull-right">sa</strong></li>
                  </ul>
                </div>
                <!-- /.col -->
              </div>
