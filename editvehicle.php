...
if (isset($_POST['editstd']) && $_POST['editstd'] == 'Save') {
    ...
    if ($msg == "") {
        ...
        $msg = '<div class="alert alert-success alert-dismissable">
					...
					Vehicle has been edited.
				</div>';
        $_SESSION["msg"] = $msg;
        redirect("editvehicle.php?ID=".(int)$ID);
    }
}
else
{
...
<head>
    ...
    <title><?php echo SITE_TITLE; ?>- Edit Vehicle</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <!-- /.box -->
                    <form id="frmPages" action="<?php echo $self.'?ID='.$_REQUEST["ID"]; ?>" class="form-horizontal" method="post"
                          enctype="multipart/form-data">
                        <div class="box ">
                            <div class="box-header">
                                <div class="btn-group-right">
                                    <button style="float:right;" type="button" class="btn btn-group-vertical btn-danger"
                                            onClick="location.href='vehicles.php'">Back
                                    </button>
                                    <input style="float:right;margin-right:15px;" type="submit" name="editstd"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" id="RegistrationNo"
                                               value="<?php echo $RegistrationNo; ?>"
                                               placeholder="Enter Registration No" name="RegistrationNo" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control" id="Details"
                                                  placeholder="Enter Details" name="Details"><?php echo $Details; ?></textarea>
                                    </div>
                                </div>
