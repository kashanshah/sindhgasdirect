              ...
              <li class="dropdown messages-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <i class="fa fa-folder-open-o" aria-hidden="true"></i>
                        ...
                        <span style="color:black; font-weight: bold"><?php echo getValue('roles', 'Name', 'ID', $_SESSION["RoleID"]); ?></span>
                        </a> 
...
<!--              <li class="dropdown tasks-menu">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="<?php echo ($_SESSION["Image"] == "" ? 'dist/img/user2-160x160.jpg' : DIR_USER_IMAGES.$_SESSION["Image"]) ?>" class="user-image" alt="User Image">
...
<!--                    <div class="col-xs-4 text-center">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="viewadmin.php?ID=<?php echo $_SESSION["ID"]; ?>" class="btn btn-default btn-flat">Profile</a>
                    </div>
