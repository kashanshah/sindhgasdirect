    ...
    if($msg=="")
    {
        ...
        if(isset($_FILES["File"]) && $_FILES["File"]['name'] != "")
        {
            ...
            if($moved2)
            {
                ...
                $_SESSION["msg"] = $msg;
                redirect("viewcustomer.php?ID=".$ID);
            }
            else
            {
                $msg='<div class="alert alert-warning alert-dismissable">
						<i class="fa fa-ban"></i>
						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
						<b>Customer has been updated but Image can not be uploaded.</b>
						</div>';
            }
        }
        else
...
<head>
    ...
    <title><?php echo SITE_TITLE; ?>- View Customer</title>
                                    ...
                                    <table class="table">
                                        ...
                                        while($row = mysql_fetch_array($res)){
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="viewsale.php?ID=<?php echo $row["SaleID"]; ?>">Invoice # <?php echo sprintf('%04u', $row["SaleID"]); ?></a></td>
                                                <td>Rs. <?php echo financials($row["Total"]); ?></td>
                                                <td>Rs. <?php echo financials($row["Paid"]); ?></td>
                                                <td>Rs. <?php echo financials($row["Adjustment"]); ?></td>
