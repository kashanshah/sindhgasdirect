                            ...
                            <div class="box-header">
                                <div class="btn-group-right">
                                    <button style="float:right;margin-right:15px;" type="button"
                                            ...
                                            onClick="location.href='admins.php'">Back
                                    </button>
                                    <button style="float:right;margin-right:15px;" type="button"
                                            class="btn btn-group-vertical btn-warning"
                                            onClick="location.href='editadmin.php?ID=<?php echo $ID; ?>'">Edit
                                    </button>
                                    <button style="float:right;margin-right:15px;" type="button"
                                            class="btn btn-group-vertical btn-danger"
                                            onClick="doSingleDelete(<?php echo $ID; ?>)">Delete
                                    </button>
                                    <button style="float:right;margin-right:15px;" type="button"
                                            class="btn btn-default " onClick="window.print()"><i
