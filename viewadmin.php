                    ...
                    <div class="form-group">
						...
						<div class="col-md-6">
							<select class="form-control" name="Gender" disabled="">
								<option value="1" <?php echo ($row["RoleID"] == "1" ? 'selected=""' : ''); ?> >Admin</option>
								<option value="2" <?php echo ($row["RoleID"] == "2" ? 'selected=""' : ''); ?> >Manager</option>
								<option value="3" <?php echo ($row["RoleID"] == "3" ? 'selected=""' : ''); ?> >Salesman</option>
							</select>
						</div>
					</div>
                    <div class="form-group">
