                    ...
                    <div class="box ">
                        <div class="box-header">
                            <div class="btn-group-right">
                                <a style="float:right;margin-right:15px;" type="button" href="cylindertosales.php"
                                   class="btn btn-group-vertical btn-info">Reset</a>
                                <a style="float:right;margin-right:15px;" type="button"
                                   class="btn btn-group-vertical btn-danger" href="cylinders.php">Back</a>
                            ...
                            <div class="box-body">
                                                ...
                                                while ($Rs = mysql_fetch_assoc($r)) {
                                                    if (getCurrentStatus($Rs["ID"]) == ROLE_ID_PLANT) {
                                                        ...
                                                        <option data-tierweight="<?php echo $Rs["TierWeight"]; ?>"
                                                                data-currentweight="<?php echo getCurrentWeight($Rs["ID"]); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input style="float:right;margin-right:15px;" type="button" id="AddItemButton"
                                               class="btn btn-group-vertical btn-success" value="Add"/>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="box box-body">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="example-text-input">Assign
                                                    To:</label>
                                                <div class="col-md-8">
                                                    <select class="form-control" required name="HandedTo" id="HandedTo"
                                                            style="width: 100%;">
                                                        <?php
                                                        ...
                                                        if ($n == 0) {
                                                            ...
                                                            while ($Rs = mysql_fetch_assoc($r)) { ?>
                                                                <option value="<?php echo $Rs['ID']; ?>" <?php if ($HandedTo == $Rs['ID']) {
                                                                    echo 'selected=""';
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="example-text-input">Print
                                                    Slip?</label>
                                                <div class="col-md-6">
                                                    <input type="radio" name="Print"
                                                           value="1" <?php echo($Print == "1" ? 'checked=""' : '') ?>>
                                                    Yes &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <input type="radio" name="Print"
                                                           value="0" <?php echo($Print == "0" ? 'checked=""' : '') ?>>
                                                    No
                                                </div>
                                            </div>
...
<script>
    ...
    $("#AddItemButton").click(function () {
        ...
        if (j != 1) {
            $(".cart_table").append('<tr class="DivCartCylinder' + $("[name='CylinderID']").val() + '"></td>');
            ...
            $(".cart_table .DivCartCylinder" + $("[name='CylinderID']").val()).append('<td><span class="CylinderCartName CylinderCartName' + i + '" >' + $("[name='CylinderID'] option:selected").text() + '</span></td>');
            $(".cart_table .DivCartCylinder" + $("[name='CylinderID']").val()).append('<td><span id="CylinderTierWeight' + i + '">' + $("[name='CylinderID'] option:selected").data('tierweight') + '</span></td>');
            $(".cart_table .DivCartCylinder" + $("[name='CylinderID']").val()).append('<td>' + $("[name='CylinderID'] option:selected").data('currentweight') + '</td>');
            $(".cart_table .DivCartCylinder" + $("[name='CylinderID']").val()).append('<td style="display: none;"><input type="number" name="CylinderWeight[]" class="CylinderWeight CylinderWeight' + i + '" data-id="' + i + '" required="" value="' + $("[name='CylinderID'] option:selected").data('currentweight') + '" /></td>');
            $(".cart_table .DivCartCylinder" + $("[name='CylinderID']").val()).append('<td><span id="CylinderGasWeight' + i + '"></span></td>');
            $(".cart_table .DivCartCylinder" + $("[name='CylinderID']").val()).append('<td><div class="btn-group"><a class="btn btn-danger dropdown-toggle" onclick="deletethisrow(this);">Delete</a></div></td>');
