	...
	if(isset($_REQUEST['ids']) && is_array($_REQUEST['ids']))
	{
		foreach($_REQUEST['ids'] as $CID)	
		{
			...
			$_SESSION["msg"] = '<div class="alert alert-danger alert-dismissable">
                    ...
                    <h4><i class="icon fa fa-ban"></i> User(s) Deleted!</h4>
                  </div>';
		}
	}
...
<html>
  <head>
    ...
    <title><?php echo SITE_TITLE; ?>- Users Management</title>
              ...
              <div class="box">
                <div class="box-header">
                      <div class="btn-group-right">
                       ...
                       <a style="float:right;margin-right:15px;" type="button" class="btn btn-group-vertical btn-success" href="adduser.php" data-original-title="" title="">Add New</a>
...
<?php while($row=mysql_fetch_array($resource))
{
	?>
                      <tr>
                        ...
                        <td>
							<a class="btn btn-primary btn-xs" title="Edit" href="edituser.php?ID=<?php echo $row["ID"]; ?>"><i class="fa fa-pencil"></i></a>
