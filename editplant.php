        ...
        if(isset($_FILES["File"]) && $_FILES["File"]['name'] != "")
        {
            ...
            else
            {
                $msg='<div class="alert alert-warning alert-dismissable">
						<i class="fa fa-ban"></i>
						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
						<b>Plant has been updated but Image can not be uploaded.</b>
						</div>';
            }
        }
        else
...
<head>
    ...
    <title><?php echo SITE_TITLE; ?>- Edit Plant</title>
                        ...
                        <div class="box box-default">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="radio" value="1" name="Status" <?php echo ($Status == "1" ? 'checked=""' : '') ?>> Enabled
                                        <input type="radio" value="0" name="Status" <?php echo ($Status == "0" ? 'checked=""' : '') ?>> Disabled
                                    </div>
                                </div>
                                <div class="form-group">
