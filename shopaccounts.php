...
$msg='';
$sql="SELECT u.ID, u.Username, u.Password, u.Balance, u.Remarks, r.Name AS Role, u.Address, u.Number, u.Name FROM users u LEFT JOIN roles r ON r.ID = u.RoleID where u.ID<>0 AND u.RoleID=".ROLE_ID_SHOP."";
...
<head>
    ...
    <title><?php echo SITE_TITLE; ?>- Shop Accounts</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Shop Accounts</li>
            </ol>
        </section>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <?php while($row=mysql_fetch_array($resource))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo (int)$row["Balance"]; ?></td>
                                            <td>
                                            <?php
                                            if($row["Balance"] < 0){
                                                $osisql="SELECT p.ID, p.Total, p.Balance, p.Paid, p.Unpaid, p.RefNum, p.Note, p.DateAdded, p.DateModified FROM purchases p WHERE p.ShopID = ".$row["ID"]." AND p.Unpaid > 0 ";
