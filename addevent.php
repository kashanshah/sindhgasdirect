...
get_right(array(1, 2));
	...
	if(isset($_POST['addstd']) && $_POST['addstd']=='Save')
	{
		...
		if($msg=="")
		{
			...
			$txt = "\n".date('r').": \nEVENT ADDED by ".$_SESSION["UserName"].": \nEvent ID='".mysql_insert_id()."', Title='".$Title."', StartDate='".$StartDate."', EndDate='".$EndDate."', Details='".$Details."'\n";
...
<html>
  <head>
    ...
    <title><?php echo SITE_TITLE; ?>- Add Event</title>
              ...
              <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
						...
						<div class="col-md-6">
							<input type="date" class="form-control" id="eventple-text-input" value="<?php echo $StartDate;?>" name="StartDate">
						</div>
					</div>
                    <div class="form-group">
						<label class="col-md-3 control-label" for="eventple-text-input">End Date</label>
						<div class="col-md-6">
							<input type="date" class="form-control" id="eventple-text-input" value="<?php echo $EndDate;?>" name="EndDate">
						</div>
					</div>
                    <div class="form-group">
