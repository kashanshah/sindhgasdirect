	...
	if(isset($_REQUEST['ids']) && is_array($_REQUEST['ids']))
	{
		foreach($_REQUEST['ids'] as $CID)	
		{
			...
			$_SESSION["msg"] = '<div class="alert alert-danger alert-dismissable">
                    ...
                    <h4><i class="icon fa fa-ban"></i> Admin(s) Deleted!</h4>
                  </div>';
		}
	}
...
$sql="SELECT u.ID, u.Username, u.Password, u.Remarks, r.Name AS Role, u.Address, u.Number, u.Name, u.FatherName FROM users u LEFT JOIN roles r ON r.ID = u.RoleID where u.Status<>0";
...
<html>
  <head>
    ...
    <title><?php echo SITE_TITLE; ?>- Admin Management</title>
